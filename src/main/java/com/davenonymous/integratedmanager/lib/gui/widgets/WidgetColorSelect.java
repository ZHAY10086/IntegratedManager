...
import com.davenonymous.integratedmanager.lib.gui.event.MouseEnterEvent;
...
public class WidgetColorSelect extends WidgetWithChoiceValue<Color> {
	...
	protected static final ResourceLocation BUTTON_TEXTURES = IntegratedManager.resource("textures/gui/widgets.png");
